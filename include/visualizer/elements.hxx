...
namespace sv
{
    ...
    public:
            ...
            , m_sfx{ std::move(elems.m_sfx) }
        {
            ...
            elems.m_accumulated_delay     = duration_type{};
        ...
        explicit Elements(
            ...
            , m_accumulated_delay{ duration_type{} }
            ...
            -> element_type
        {
            ...
            m_accumulated_delay += m_read_delay;
            ...
            -> void
        {
            ...
            m_accumulated_delay += m_write_delay;
    ...
    private:
        ...
        auto _M_generate()
            noexcept -> void
        {
            auto delta { (m_max_value - m_min_value) / static_cast<float>(m_sort_amount) };
            std::ranges::generate(
                m_items,
                [&, i=1]() mutable 
                { 
                    auto v = m_min_value + (static_cast<float>(i) * delta);
                    i += 1;
                    return v;
                }
            );
    ...
    private:
        element_type                m_max_value;
        element_type                m_min_value;
        ...
        duration_type               m_accumulated_delay;
